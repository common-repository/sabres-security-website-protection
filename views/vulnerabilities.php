...
<script src="<?php echo plugins_url('javascript/sabres-vulnerabilities.js', __DIR__); ?>"></script>
...
<div class="container-fluid sabres-vulnerabilities">
        ...
        <div class="col-lg-10 col-md-9 col-sm-8">
            <div class="panel panel-settings">
                ...
                <div class="panel-body">
                    <table class="data-table data-table-full-width vulnerabilities">
                        <thead>
                            <tr>
                                <th>Type</th>
                                <th>Description</th>
